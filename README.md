# lampster - магазин светильников (JavaScript, Express, MongoDB)
...
Клиентская часть данного проекта реализована на чистом JavaScript. Серверная часть реализована на Express.js.
