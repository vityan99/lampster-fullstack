...
Данный проект также был реализован с использованием библиотеки React. С ним можно ознакомиться по [ссылке](https://github.com/vityan99/lampster-react-fullstack/tree/main)
